...
const FacebookPreview: React.FC<PlatformProps> = ({ content }) => {
  return (
    <div className="border border-gray-200 rounded-lg bg-white w-full max-w-2xl shadow-sm">
      ...
      <div className="flex items-center p-4 border-b border-gray-200">
        ...
        <div className="ml-3 flex-1">
          <div className="font-semibold text-base text-gray-900">Facebook User</div>
          <div className="text-sm text-gray-500">2 hours ago · <span className="text-blue-600">🌍</span></div>
        </div>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            <div className="bg-gray-100 rounded-2xl px-4 py-2">
              ...
              <div className="text-sm text-gray-700">Great post! Thanks for sharing.</div>
            </div>
        ...
        <div className="flex items-center space-x-3 mt-4">
          ...
          <div className="flex-1 relative">
            <input
              ...
              className="w-full px-4 py-2 bg-gray-100 rounded-full text-sm text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white"
            />
