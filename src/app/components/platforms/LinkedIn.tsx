    ...
    <div className="border border-gray-200 rounded-lg bg-white w-full max-w-2xl shadow-sm">
      ...
      <div className="flex items-start p-4 border-b border-gray-200">
        ...
        <div className="ml-3 flex-1 min-w-0">
          <div className="font-semibold text-base text-gray-900">LinkedIn User</div>
          <div className="text-sm text-gray-600">Software Engineer at Tech Company</div>
        ...
        <div className="flex items-start space-x-3 mb-4">
          ...
          <div className="flex-1">
            <div className="bg-gray-50 rounded-lg px-4 py-3 border border-gray-200">
              ...
              <div className="text-sm text-gray-700">Great insights! This really resonates with my experience in the industry.</div>
